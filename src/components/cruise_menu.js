...
class CruiseMenu extends Component {
  ...
  renderCruiseListItems() {
    ...
    return this.props.cruises.map((cruise, index) => {
      ...
      let cruiseDescription = (cruise.cruise_additional_meta.cruise_description)? <p><strong>Cruise Description:</strong> {cruise.cruise_additional_meta.cruise_description}</p> : null
